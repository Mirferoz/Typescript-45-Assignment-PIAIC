...
// list of animals with a common characteristics
const animals: string[] = ["dog","cat","cow"]

// Printing the names of each animals using a for loop
...
console.log("Any of these animals are could be a great animals");